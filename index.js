...
// TC cruzado EUR → ARS blue: (EUR_oficial_venta / USD_oficial_venta) × USD_blue_venta
...
- "50 usd", "50 u$s", "50 dólares", "usd 50" → USD
...
NOTAS SOBRE CAMBIO DE MONEDA:
- Si el usuario dice "vendí 100 dólares a 1400", monto_origen=100 moneda_origen=USD, moneda_destino=ARS, monto_destino=140000.
- Si no da el monto_destino explícito (ej. "vendí 100 dólares"), dejalo en 0 y el sistema lo calcula con el TC blue actual.
- Si dice "cambié 500 dólares a pesos hoy" sin monto de destino, igual: monto_destino=0.
...
app.get("/", (req, res) => res.json({ status: "MamiFin Bot activo 🟢 — Argentina" }));
